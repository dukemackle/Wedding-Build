...
Read this when the conversation is about pricing, charging vendors, revenue,
or whether it's time to move phases. It is deliberately not in `CLAUDE.md`:
it's reference, and `CLAUDE.md` is re-sent with every message.
